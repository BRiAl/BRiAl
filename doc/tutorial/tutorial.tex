...
Even more low-level than operation with \functionname{subset}-methods is the use of navigators. Navigators are provide an interface to diagram nodes, accessing there index and then- and else-branches.
...
/home/michael/sing/PolyBoRi/<ipython console> in <module>()

<type 'exceptions.ValueError'>: Node index must be smaller than top indices of then- and else-branch.
...
\section{Lexicographical normal form of polynomial against a variety}
