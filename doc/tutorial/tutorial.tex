...
Basic arithmetic is provided in the domain of Boolean polynomials. If exponents bigger than one per variable appear reduction by the field ideal is done automatically.
\begin{verbatim}
