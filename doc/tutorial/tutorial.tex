...
The i-th entry of $v$ is set to 1, iff the i-th variable occurs in $m$.
...
The full vector space can be constructors by multiplying all needed variables and the set of divisors of the product.
...
We distingish between procedures, where also subset of the ambient space can be used like finding zeroes of a polynomial and procedures, where only the dimension/involved unit vectors/variables matters.
