...
The core of \PolyBoRi is a C++ library. On top of there exists a Python interface.
Additionally to the Python interface a interface to SAGE was provided by Burcin Erocal.
...
\end{verbatim}
In this example, we have a ordering composed of three blocks, one with the first ten variables, the second contains the $x(10), \ldots x(19)$ (per default indices start at 0).
